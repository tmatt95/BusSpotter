...
<div class="row">
    ...
    <div class="span2 rightMenu">
        <?php if (Yii::app()->user->isGuest == false) { ?>
            <?php echo CHtml::link('<span class="icon-pencil"></span> Edit Information', array('vehicles/update', 'id' => $id), array('class' => 'btn rightLink')); ?>
        <?php } ?>
    </div>
</div>
<div class="form">
...
<ul class="nav nav-tabs" id="myTab" style="margin-bottom: 10px;">
    <li class="active"><a href="#home">Comments <span class="badge" data-bind="text: comments().length">0</span></a></li>
    <li><a href="#spottings">Spottings <span class="badge" data-bind="text: spottings().length">0</span></a></li>
</ul>
            ...
            <div class="row">
                ...
                <div class="span2">
                    <input 
                        ...
                        data-bind="click: addComment, enable: self.commentText().length > 0" 
                        value="Add Comment" />
                </div>
            </div>
        <?php } ?>
